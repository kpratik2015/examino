...
import com.ibm.mobileappbuilder.examino20160923051552.presenters.DMSAQDetailPresenter;
...
public class DMSAQDetailFragment extends ibmmobileappbuilder.ui.DetailFragment<QuestionsDSItem> implements ShareBehavior.ShareListener  {

    private CrudDatasource<QuestionsDSItem> datasource;
    public static DMSAQDetailFragment newInstance(Bundle args){
        DMSAQDetailFragment fr = new DMSAQDetailFragment();
        fr.setArguments(args);

        return fr;
    }

    public DMSAQDetailFragment(){
        super();
    }
    ...
    public void onCreate(Bundle state) {
        ...
        setPresenter(new DMSAQDetailPresenter(
    ...
    protected int getLayout() {
        return R.layout.dmsaqdetail_detail;
    }
    ...
    public void onShare() {
        ...
        intent.putExtra(Intent.EXTRA_SUBJECT, "DMSA Q.");
