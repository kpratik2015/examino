...
public class CFCAQMenuItem1DetailPresenter extends BasePresenter implements DetailCrudPresenter<QuestionsDSItem>,
      Datasource.Listener<QuestionsDSItem> {

    private final CrudDatasource<QuestionsDSItem> datasource;
    private final DetailView view;

    public CFCAQMenuItem1DetailPresenter(CrudDatasource<QuestionsDSItem> datasource, DetailView view){
