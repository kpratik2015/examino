...
import com.ibm.mobileappbuilder.examino20160923051552.presenters.DMSAQPresenter;
...
/**
 * "DMSAQFragment" listing
 */
public class DMSAQFragment extends ListGridFragment<QuestionsDSItem> implements CrudListView<QuestionsDSItem> {
    ...
    public static DMSAQFragment newInstance(Bundle args) {
        DMSAQFragment fr = new DMSAQFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setPresenter(new DMSAQPresenter(
    ...
    */
    ...
    public void showDetail(QuestionsDSItem item, int position) {
        ...
        Intent intent = new Intent(getActivity(), DMSAQDetailActivity.class);
