...
public class DCWSNQDetailPresenter extends BasePresenter implements DetailCrudPresenter<QuestionsDSItem>,
      Datasource.Listener<QuestionsDSItem> {

    private final CrudDatasource<QuestionsDSItem> datasource;
    private final DetailView view;

    public DCWSNQDetailPresenter(CrudDatasource<QuestionsDSItem> datasource, DetailView view){
