...
import com.ibm.mobileappbuilder.examino20160923051552.presenters.CFCAQMenuItem1DetailPresenter;
...
public class CFCAQMenuItem1DetailFragment extends ibmmobileappbuilder.ui.DetailFragment<QuestionsDSItem> implements ShareBehavior.ShareListener  {

    private CrudDatasource<QuestionsDSItem> datasource;
    public static CFCAQMenuItem1DetailFragment newInstance(Bundle args){
        CFCAQMenuItem1DetailFragment fr = new CFCAQMenuItem1DetailFragment();
        fr.setArguments(args);

        return fr;
    }

    public CFCAQMenuItem1DetailFragment(){
        super();
    }
    ...
    public void onCreate(Bundle state) {
        ...
        setPresenter(new CFCAQMenuItem1DetailPresenter(
    ...
    protected int getLayout() {
        return R.layout.cfcaqmenuitem1detail_detail;
    }
    ...
    public void onShare() {
        ...
        intent.putExtra(Intent.EXTRA_SUBJECT, "CFCA");
