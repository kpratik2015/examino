...
public class CFCAQMenuItem1Presenter extends BasePresenter implements ListCrudPresenter<QuestionsDSItem>,
    ...
    public CFCAQMenuItem1Presenter(CrudDatasource<QuestionsDSItem> crudDatasource,
