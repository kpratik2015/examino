...
public class DCWSNQPresenter extends BasePresenter implements ListCrudPresenter<QuestionsDSItem>,
    ...
    public DCWSNQPresenter(CrudDatasource<QuestionsDSItem> crudDatasource,
