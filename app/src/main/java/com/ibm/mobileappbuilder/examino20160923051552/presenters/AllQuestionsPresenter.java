...
public class AllQuestionsPresenter extends BasePresenter implements ListCrudPresenter<QuestionsDSItem>,
    ...
    public AllQuestionsPresenter(CrudDatasource<QuestionsDSItem> crudDatasource,
