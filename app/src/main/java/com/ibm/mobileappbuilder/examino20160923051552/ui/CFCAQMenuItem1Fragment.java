...
import com.ibm.mobileappbuilder.examino20160923051552.presenters.CFCAQMenuItem1Presenter;
...
/**
 * "CFCAQMenuItem1Fragment" listing
 */
public class CFCAQMenuItem1Fragment extends ListGridFragment<QuestionsDSItem> implements CrudListView<QuestionsDSItem> {
    ...
    public static CFCAQMenuItem1Fragment newInstance(Bundle args) {
        CFCAQMenuItem1Fragment fr = new CFCAQMenuItem1Fragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setPresenter(new CFCAQMenuItem1Presenter(
    ...
    protected SearchOptions getSearchOptions() {
      ...
      searchOptionsBuilder
          ...
          .withSortColumn("type");
            searchOptionsBuilder
                    .withFixedFilters(Arrays.<Filter>asList(new StringFilter("subject", "CFCA")));
    ...
    */
    ...
    protected int getItemLayout() {
        return R.layout.cfcaqmenuitem1_item;
    }
    ...
    public void showDetail(QuestionsDSItem item, int position) {
        ...
        Intent intent = new Intent(getActivity(), CFCAQMenuItem1DetailActivity.class);
