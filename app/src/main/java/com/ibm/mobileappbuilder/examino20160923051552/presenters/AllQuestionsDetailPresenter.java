...
public class AllQuestionsDetailPresenter extends BasePresenter implements DetailCrudPresenter<QuestionsDSItem>,
      Datasource.Listener<QuestionsDSItem> {

    private final CrudDatasource<QuestionsDSItem> datasource;
    private final DetailView view;

    public AllQuestionsDetailPresenter(CrudDatasource<QuestionsDSItem> datasource, DetailView view){
