...
import com.ibm.mobileappbuilder.examino20160923051552.presenters.AllQuestionsDetailPresenter;
...
public class AllQuestionsDetailFragment extends ibmmobileappbuilder.ui.DetailFragment<QuestionsDSItem> implements ShareBehavior.ShareListener  {

    private CrudDatasource<QuestionsDSItem> datasource;
    public static AllQuestionsDetailFragment newInstance(Bundle args){
        AllQuestionsDetailFragment fr = new AllQuestionsDetailFragment();
        fr.setArguments(args);

        return fr;
    }

    public AllQuestionsDetailFragment(){
        super();
    }
    ...
    public void onCreate(Bundle state) {
        ...
        setPresenter(new AllQuestionsDetailPresenter(
    ...
    protected int getLayout() {
        return R.layout.allquestionsdetail_detail;
    }
